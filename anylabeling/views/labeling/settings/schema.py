...
EXCLUDED_KEYS = frozenset(
    {
        ...
        "pose_view",
        "pose_view.enabled",
        "pose_view.layout_mode",
        "pose_view.color_mode",
        "pose_view.font_size",
        "pose_view.opacity",
        ...
        "pose_view.show_bbox",
        "pose_view.occlusion_highlight",
        "pose_view.show_leader",
        "pose_view.font_shadow",
        "pose_view.font_color_mode",
        "pose_view.custom_font_color",
        "pose_view.body_colors",
        "pose_view.person_colors",
        "pose_view.color_preset",
    }
)
