...
> **设计决策**：简化版聚焦最核心的「独立拖单边」诉求，降低复杂度。吸附对齐虽然更强大，但增加了状态机复杂度和学习成本，在当前场景下投入产出比不划算。这个权衡过程记录在 [docs/矩形边对齐功能实现任务文档.md](../矩形边对齐功能实现任务文档.md)。
...
- [`docs/矩形边对齐功能实现任务文档.md`](../矩形边对齐功能实现任务文档.md) — 完整任务/设计文档（含演进记录）
